...
Now try this exercise with another PhenoCam site. Perhaps choose a different ecosystem type!

To do this, edit the cell near the beginning where you assign the site name, vegtation type, year, and ROI (in the "Download & Plot Canopy Greenness" section). Then be sure to run that cell and all cells below it in sequential order.

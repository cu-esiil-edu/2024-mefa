...
# Create line plot
plot(GCC_timeseries$date, GCC_timeseries$ggc_90,
...
To do this, edit the cell near the beginning where you assign the site name, vegtation type, year, and ROI (in the "Download & Plot Canopy Greenness" section). Be sure to re-run that cell and all cells below it in sequential order.
